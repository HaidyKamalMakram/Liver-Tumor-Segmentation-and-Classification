...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restorePreData()){
            Intent mainActivity = new Intent(getApplicationContext(), SignInUpActivity.class);
        ...
        mList.add(new ScreenItem("Love Your Liver", "You should care about your food,\nand eat healthy food.", R.drawable.splash_page_one));
        mList.add(new ScreenItem("Your Health", "You must monitor your health\n by conducting tests and scans.", R.drawable.splash_page_two));
